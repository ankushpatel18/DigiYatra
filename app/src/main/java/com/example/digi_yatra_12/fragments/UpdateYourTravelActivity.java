...
public class UpdateYourTravelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                IntentIntegrator intentIntegrator = new IntentIntegrator(UpdateYourTravelActivity.this);
...
//                message.setText(valuesContent);
                Intent intent =new Intent(UpdateYourTravelActivity.this, ScanBordingPassActivity.class);
